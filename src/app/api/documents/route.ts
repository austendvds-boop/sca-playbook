...
export async function POST(req: Request) {
  ...
  const doc = { id: crypto.randomUUID(), name: body.name || (docType === 'play_card' ? 'New Install Sheet' : 'Reference Sheet'), docType, layoutData: makeDefaultDocLayout(docType), updatedAt: new Date().toISOString() };
