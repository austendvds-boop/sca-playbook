        ...
        <div className="relative" ref={folderMenuRef}>
          ...
          {folderMenuOpen ? (
            <div className="absolute z-20 mt-1 w-full rounded-xl border border-[#003087]/15 bg-white p-1 shadow-lg" role="menu">
              <button type="button" onClick={() => { setFolderId(''); setFolderMenuOpen(false); }} className="block w-full rounded-lg px-3 py-2 text-left text-sm text-[#003087] hover:bg-[#003087]/10">
                All folders
              </button>
              {folders.map((f) => (
